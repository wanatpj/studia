 ...
 */
  ...
  /* Profiling
   */
  if(tracked_proc_nr==proc_ptr->p_nr){
  	++counter_table[PROFILING_PARTS*(int)proc_ptr->p_reg.pc/((int)(proc_ptr->p_memmap[T].mem_len << CLICK_SHIFT))];
  }
